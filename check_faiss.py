...
index_path = "/home/shtlp_0058/Desktop/RAG Project/embeddings/full_faiss_index"
...
if not os.path.exists(index_path):
    ...
    query = "What is computer architecture?"
    retrieved_docs = vector_store.similarity_search(query, k=5)  # Get top 5 docs
